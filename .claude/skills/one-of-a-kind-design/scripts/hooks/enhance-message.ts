...
const STYLE_IDS = [
  "art-deco", "impressionism", "constructivism", "art-nouveau", "bauhaus",
  "de-stijl", "rococo", "surrealism", "pop-art", "minimalism-fine-art",
  "flat-design", "material-design", "neomorphism", "glassmorphism",
  "brutalist-web", "skeuomorphism", "aurora-ui", "claymorphism",
  "dark-mode-ui", "isometric", "line-art", "risograph", "duotone",
  "woodcut", "retro-vintage-print", "papercut", "low-poly", "pixel-art",
  "wabi-sabi", "scandinavian-minimalism", "psychedelic", "afrofuturism",
  "vaporwave", "ukiyo-e", "memphis-design", "swiss-international",
  "generative-art", "glitch", "fractal", "ai-diffusion",
  "cellular-automata", "noise-field", "particle-systems", "wireframe-mesh",
  "cinematic", "tilt-shift", "analog-film-grain", "hdr-hyperrealism",
  "infrared-photography", "cyanotype", "double-exposure",
  "miniature-diorama", "studio-product", "neubrutalism", "liquid-glass",
  "bento-ui", "resonant-stark", "editorial-minimalism",
  "minimalist-maximalism", "y2k-revival", "tactile-craft-digital",
  "solarpunk", "suprematism", "arte-povera-digital", "deconstructivism",
  "mono-ha",
];
