...
export const DEFAULT_MODELS: Record<string, string> = {
  ...
  "image-edit": "fal-ai/flux-pro/v1.1",
  "style-transfer": "fal-ai/flux-pro/v1.1",
  controlnet: "fal-ai/flux-pro/v1.1",
  "video-gen": "fal-ai/wan-t2v",
  "video-camera": "fal-ai/wan-t2v",
  "video-restyle": "fal-ai/wan-t2v",
  "3d-gen": "fal-ai/flux-pro/v1.1",
  upscale: "fal-ai/flux-pro/v1.1-ultra",
  "audio-tts": "fal-ai/flux-pro/v1.1",
  "audio-music": "fal-ai/flux-pro/v1.1",
  annotation: "fal-ai/flux-pro/v1.1",
  avatar: "fal-ai/flux-pro/v1.1",
