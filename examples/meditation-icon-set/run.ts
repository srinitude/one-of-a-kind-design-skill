/**
 * meditation-icon-set — SVG example: Editorial Minimalism style.
 * Reproduces the exact invocation from the 20-test validation suite.
 *
 * Run: bun run examples/meditation-icon-set/run.ts
 */
...
const USER_PROMPT = "Icon set for a meditation app. 12 icons. Calm, minimal.";

const program = Effect.gen(function* () {
  yield* Console.log("=== Meditation Icon Set ===\n");
